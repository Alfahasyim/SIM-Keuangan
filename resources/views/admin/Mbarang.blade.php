        ...
        <div class="table-responsive">
                  ...
                  <div class="modal-content animated fadeIn">
                      ...
                      <div class="modal-body">
                        <form id="AddInput" class="form-horizontal">
                          {{ csrf_field() }}
                            <div class="form-group"><label class="col-sm-4 control-label">Nama Barang</label>
                                <div class="col-sm-10">
                      ...
                      <div class="modal-footer" id="modal-footer">
                          <button type="button" class="btn btn-white" name="close" id="close" data-dismiss="modal">Close</button>
          ...
          <tbody>
            ...
            <tr id="row_{{$barang->kode_barang}}">
                ...
                @endif
                <td><span class="label label-info">{{$barang->user->nama_user}}</span></td>
                <td>
                  <button type="submit" name="edit-{{$barang->kode_barang}}" id="edit-{{$barang->kode_barang}}" onclick="editPost(event)" data-id="{{$barang->kode_barang}}" class="btn btn-info " ><i class="fa fa-paste"></i> Edit</button>
                  <button type="submit" name="delete" id="delete" data-id="{{$barang->kode_barang}}" value="{{$barang->kode_barang}}" class="btn btn-danger delete" > <i class="fa fa-trash"> Hapus</i></button>
                </td>
            </tr>
            @endforeach
            @endif
...
<script>
  ...
  $('.delete').on('click', function(){
    ...
    let _url = APP_URL + `/admin/deleteBarang/${id}`;
    ...
    function updatePost(e){
      var id = $(e.target).data("id");
      var APP_URL = {!! json_encode(url('')) !!}
      let _url = APP_URL + `/admin/updateBarang/${id}`;

      var fd;
      fd = new FormData(); 
      fd.append('nama_barang', $('#nama_barang').val());
