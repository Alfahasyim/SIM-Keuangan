      ...
      <table class="table table-striped table-bordered table-hover dataTables-example">
        ...
        <tbody>
          ...
          <tr id="row_{{$item->id}}">
            ...
            <td>
              <a href="{{route('keuangan.ListOrderMasuk')}}/{{$item->id}}/LM" target="_blank" class="btn btn-info" >Laporan Masuk</a> 
              <a href="{{route('keuangan.ListOrderMasuk')}}/{{$item->id}}/LK" target="_blank" class="btn btn-info" >Laporan Keluar</i></a> <button type="submit" name="delete" id="delete" data-id="{{$item->id}}" value="{{$item->id}}" class="btn btn-danger delete" > <i class="fa fa-trash"> Hapus</i></button>
            </td> 
          </tr>
          @endforeach
          @endif
...
<script>
  ...
  $('.delete').on('click', function(){
    ...
    let _url = APP_URL + `/keuangan/deleteListOrderMasuk/${id}`;
