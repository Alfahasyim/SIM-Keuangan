      ...
      <table class="table table-striped table-bordered table-hover dataTables-example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="/keuangan/ListOrderMasuk/{{$item->id}}/LM" target="_blank" class="btn btn-info" >Laporan Masuk</a> 
              <a href="/keuangan/ListOrderMasuk/{{$item->id}}/LK" target="_blank" class="btn btn-info" >Laporan Keluar</i></a> 
              </button>
            </td> 
          </tr>
          @endforeach
